...
var _ = Describe("RetryExecuteBehavioral", func() {
	Context("with no error", func() {
		...
		BeforeAll(func() {
			...
			executor.SetStrategy(event_executor.NewRetryExecutor(1, 1, producer, publisher, storageData))
		...
		It("should consumed message value equals to expected payload", func() {
